...
!(function (e, t) {
  ...
  T.extend({
    cssHooks: {
      opacity: {
        get: function (e, t) {
          if (t) return "" === (e = Ge(e, "opacity")) ? "1" : e;
        },
      },
    },
    cssNumber: {
  ...
  (T.Animation = T.extend(Tt, {
    ...
    (mt = (o = h.createElement("select")).appendChild(
  ...
  T.fn.extend({
    ...
    Dt ||
      ...
      (T.valHooks.button = {
        get: function (e, t) {
          return (t = e.getAttributeNode(t)) && t.specified ? t.value : void 0;
        },
        set: Nt.set,
      }),
    ...
    ajax: function (e, t) {
      ...
      var n,
        ...
        b = {
          ...
          abort: function (e) {
            return (e = e || a), f && f.abort(e), s(0, e), this;
          },
        };
      if (
